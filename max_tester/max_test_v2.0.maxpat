...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 254.0, 163.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 582.0, 47.5, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 239.0, 148.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 48.5, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 422.0, 47.5, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 863.0, 212.0, 240.0, 53.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 373.0, 313.0, 81.0, 53.0 ],
					"text" : "Cycle   \n RGB"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 375.0, 162.833344, 32.5, 20.0 ],
									"text" : "t 7 i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 375.0, 134.833344, 135.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 312.0, 134.833344, 32.5, 20.0 ],
									"text" : "t 7 i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 312.0, 106.833344, 135.0, 20.0 ],
									"text" : "if $i1 == 0 then 1 else 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 259.0, 106.833344, 32.5, 20.0 ],
									"text" : "t 7 i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 259.0, 78.833336, 135.0, 20.0 ],
									"text" : "if $i1 == 0 then 1 else 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 237.0, 160.0, 54.0, 20.0 ],
									"text" : "gate 1 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 200.5, 160.0, 54.0, 20.0 ],
									"text" : "gate 1 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 154.5, 160.0, 54.0, 20.0 ],
									"text" : "gate 1 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 259.0, 25.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 80.0, 165.0, 127.0, 20.0 ],
					"saved_object_attributes" : 					{
						"tags" : "",
						"globalpatchername" : "",
						"default_fontface" : 0,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 269.5, 66.0, 246.0, 66.0, 246.0, 129.0, 89.5, 129.0 ],
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 332.5, 66.0, 318.0, 66.0, 318.0, 96.0, 309.0, 96.0, 309.0, 129.0, 89.5, 129.0 ],
					"source" : [ "obj-45", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 89.5, 174.0, 167.5, 174.0 ],
					"source" : [ "obj-54", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 308.5, 267.0, 129.0, 267.0, 129.0, 129.0, 107.5, 129.0 ],
					"source" : [ "obj-56", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 392.5, 279.0, 129.0, 279.0, 129.0, 129.0, 125.5, 129.0 ],
					"source" : [ "obj-57", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 476.5, 279.0, 129.0, 279.0, 129.0, 138.0, 143.5, 138.0 ],
					"source" : [ "obj-58", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "header.jpg",
				"bootpath" : "/Users/thealphanerd/github/BlinkM_RGB_Switcher/max_tester",
				"patcherrelativepath" : "",
				"type" : "JPEG",
				"implicit" : 1
			}
, 			{
				"name" : "ArduinoUnoFront_png_550x350_q851.jpg",
				"bootpath" : "/Users/thealphanerd/github/BlinkM_RGB_Switcher/max_tester",
				"patcherrelativepath" : "",
				"type" : "JPEG",
				"implicit" : 1
